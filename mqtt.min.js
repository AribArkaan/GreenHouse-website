    ...
    return function () {
                ...
                (function () {
                    ...
                    function y(e, t, r) {
                        ...
                        h("sendPacket :: writeToStream result %s", n),
                            !n && r ? (h("sendPacket :: handle events on `drain` once through callback."),
                                e.stream.once("drain", r)) : r && (h("sendPacket :: invoking cb"),
                                    r())
                    }
                    function _(e, t, r, n) {
                        h("storeAndSend :: store packet with cmd %s to outgoingStore", t.cmd),
                    ...
                    function v(e, t) {
                        ...
                        h("MqttClient :: options.protocol", t.protocol),
                            h("MqttClient :: options.protocolVersion", t.protocolVersion),
                            h("MqttClient :: options.username", t.username),
                            h("MqttClient :: options.keepalive", t.keepalive),
                            h("MqttClient :: options.reconnectPeriod", t.reconnectPeriod),
                            h("MqttClient :: options.rejectUnauthorized", t.rejectUnauthorized),
                            ...
                            this.queueQoSZero = void 0 === t.queueQoSZero || t.queueQoSZero,
                            ...
                            this.on("connect", function () {
                                ...
                                h("connect :: sending queued packets"),
                                    function t() {
                                        ...
                                        var i;
                                        r && (i = r.packet,
                                            h("deliver :: call _sendPacket for %o", i),
                    ...
                    c(v, i),
                        v.prototype._setupStream = function () {
                            var e, t = this, r = new a, n = s.parser(this.options), i = null, o = [];
                            function c() {
                                if (o.length)
                                    p(u);
                                else {
                            ...
                            if (h("_setupStream :: calling method to clear reconnect"),
                                this._clearReconnect(),
                                h("_setupStream :: using streamBuilder provided to client to create stream"),
                                ...
                                this.stream.on("error", function (e) {
                                    h("streamErrorHandler :: error", e.message),
                                        b.includes(e.code) ? (h("streamErrorHandler :: emitting error"),
                                            t.emit("error", e)) : w(e)
                                }),
                                this.stream.on("close", function () {
                                    var e;
                                    h("(%s)stream :: on close", t.options.clientId),
                                        (e = t.outgoing) && (h("flushVolatile :: deleting volatile messages from the queue and setting their callbacks as error function"),
                                ...
                                if (!this.options.properties.authenticationMethod && this.options.properties.authenticationData)
                                    return t.end(() => this.emit("error", new Error("Packet has no Authentication Method"))),
                                        this;
                        ...
                        v.prototype._handlePacket = function (e, t) {
                            var r = this.options;
                            if (5 === r.protocolVersion && r.properties && r.properties.maximumPacketSize && r.properties.maximumPacketSize < e.length)
                                return this.emit("error", new Error("exceeding packets size " + e.cmd)),
                                    this.end({
                                        reasonCode: 149,
                                        properties: {
                                    ...
                                    this;
                            switch (h("_handlePacket :: emitting packetreceive"),
                            ...
                            e.cmd) {
                                ...
                                case "pubrel":
                                    ...
                                    break;
                                case "connack":
                                    this._handleConnack(e),
                                        t();
                                    break;
                                case "pingresp":
                                    this._handlePingresp(e),
                                        t();
                                    break;
                                case "disconnect":
                        ...
                        v.prototype.publish = function (e, t, r, n) {
                            ...
                            5 === o.protocolVersion && (i.properties = r.properties,
                                (!o.properties && i.properties && i.properties.topicAlias || r.properties && o.properties && (r.properties.topicAlias && o.properties.topicAliasMaximum && r.properties.topicAlias > o.properties.topicAliasMaximum || !o.properties.topicAliasMaximum && r.properties.topicAlias)) && delete i.properties.topicAlias),
                            h("publish :: qos", r.qos),
                            r.qos) {
                                case 1:
                                case 2:
                                    this.outgoing[i.messageId] = {
                                        ...
                                        this._storeProcessing ? (h("_storeProcessing enabled"),
                                            this._packetIdsDuringStoreProcessing[i.messageId] = !1,
                                            this._storePacket(i, void 0, r.cbStorePut)) : (h("MqttClient:publish: packet cmd: %s", i.cmd),
                                                this._sendPacket(i, void 0, r.cbStorePut));
                                    break;
                                default:
                                    this._storeProcessing ? (h("_storeProcessing enabled"),
                                        this._storePacket(i, n, r.cbStorePut)) : (h("MqttClient:publish: packet cmd: %s", i.cmd),
                        ...
                        v.prototype.subscribe = function () {
                            for (var e, t = new Array(arguments.length), r = 0; r < arguments.length; r++)
                                t[r] = arguments[r];
                            var n, i = [], o = t.shift(), s = o.resubscribe, a = t.pop() || w, c = t.pop(), u = this, p = this.options.protocolVersion;
                            if (delete o.resubscribe,
                                "string" == typeof o && (o = [o]),
                                "function" != typeof a && (c = a,
                                    a = w),
                                null !== (n = l.validateTopics(o)))
                                return d(a, new Error("Invalid topic " + n)),
                                    this;
                            if (this._checkDisconnecting(a))
                                return h("subscribe: discconecting true"),
                                    this;
                            var g = {
                                qos: 0
                            };
                            if (5 === p && (g.nl = !1,
                                ...
                                Array.isArray(o) ? o.forEach(function (e) {
                                    if (h("subscribe: array topic %s", e),
                                        !u._resubscribeTopics.hasOwnProperty(e) || u._resubscribeTopics[e].qos < c.qos || s) {
                                        var t = {
                                            topic: e,
                                            qos: c.qos
                                        };
                                        5 === p && (t.nl = c.nl,
                                            ...
                                            h("subscribe: pushing topic `%s` and qos `%s` to subs list", t.topic, t.qos),
                                            i.push(t)
                                    }
                                }) : Object.keys(o).forEach(function (e) {
                                    if (h("subscribe: object topic %s", e),
                                        !u._resubscribeTopics.hasOwnProperty(e) || u._resubscribeTopics[e].qos < o[e].qos || s) {
                                        var t = {
                                            topic: e,
                                            qos: o[e].qos
                                        };
                        ...
                        v.prototype.unsubscribe = function () {
                            ...
                            return "string" == typeof i && (i = [i]),
                                "function" != typeof o && (s = o,
                                    o = w),
                                this._checkDisconnecting(o) ? this : ("string" == typeof i ? e.unsubscriptions = [i] : Array.isArray(i) && (e.unsubscriptions = i),
                                    this.options.resubscribe && e.unsubscriptions.forEach(function (e) {
                                        delete t._resubscribeTopics[e]
                                    }),
                                    "object" == typeof s && s.properties && (e.properties = s.properties),
                        ...
                        v.prototype.end = function (e, t, r) {
                            var n = this;
                            function i() {
                                h("end :: (%s) :: finish :: calling _cleanUp with force %s", n.options.clientId, e),
                                    n._cleanUp(e, () => {
                                        h("end :: finish :: calling process.nextTick on closeStores"),
                                            p(function () {
                                                h("end :: closeStores: closing incoming and outgoing stores"),
                                                    n.disconnected = !0,
                                                    n.incomingStore.close(function (e) {
                                                        n.outgoingStore.close(function (t) {
                                                            if (h("end :: closeStores: emitting end"),
                                                                n.emit("end"),
                                                                r) {
                                                                let n = e || t;
                                                                h("end :: closeStores: invoking callback with args"),
                                                                    r(n)
                                                            }
                                                        })
                                                    }),
                            ...
                            return h("end :: (%s)", this.options.clientId),
                                ...
                                h("end :: cb? %s", !!r),
                                r = r || w,
                                this.disconnecting ? (r(),
                                    this) : (this._clearReconnect(),
                                        this.disconnecting = !0,
                                        !e && Object.keys(this.outgoing).length > 0 ? (h("end :: (%s) :: calling finish in 10ms once outgoing is empty", n.options.clientId),
                                            this.once("outgoingEmpty", setTimeout.bind(null, i, 10))) : (h("end :: (%s) :: immediately calling finish", n.options.clientId),
                                                i()),
                                        this)
                        }
                        ,
                        ...
                        v.prototype.reconnect = function (e) {
                            ...
                            var t = this
                                , r = function () {
                                    e ? (t.options.incomingStore = e.incomingStore,
                                        t.options.outgoingStore = e.outgoingStore) : (t.options.incomingStore = null,
                        ...
                        v.prototype._reconnect = function () {
                            h("_reconnect: emitting reconnect to client"),
                                ...
                                this.connected ? (this.end(() => {
                                    ...
                                    h("client already connected. disconnecting first.")) : (h("_reconnect: calling _setupStream"),
                                        this._setupStream())
                        }
                        ,
                        v.prototype._setupReconnect = function () {
                            ...
                            !e.disconnecting && !e.reconnectTimer && e.options.reconnectPeriod > 0 ? (this.reconnecting || (h("_setupReconnect :: emit `offline` state"),
                                this.emit("offline"),
                                h("_setupReconnect :: set `reconnecting` to `true`"),
                                this.reconnecting = !0),
                        ...
                        v.prototype._cleanUp = function (e, t) {
                            var r, n = arguments[2];
                            if (t && (h("_cleanUp :: done callback provided for on stream close"),
                                this.stream.on("close", t)),
                                h("_cleanUp :: forced? %s", e),
                                e)
                                0 === this.options.reconnectPeriod && this.options.clean && (r = this.outgoing) && (h("flush: queue exists? %b", !!r),
                                    Object.keys(r).forEach(function (e) {
                                        "function" == typeof r[e].cb && (r[e].cb(new Error("Connection closed")),
                                            delete r[e])
                                    })),
                                    h("_cleanUp :: (%s) :: destroying stream", this.options.clientId),
                                    this.stream.destroy();
                            else {
                                var i = f({
                                    cmd: "disconnect"
                                ...
                                h("_cleanUp :: (%s) :: call _sendPacket with disconnect packet", this.options.clientId),
                                    this._sendPacket(i, d.bind(null, this.stream.end.bind(this.stream)))
                            }
                            this.disconnecting || (h("_cleanUp :: client not disconnecting. Clearing and resetting reconnect."),
                                this._clearReconnect(),
                                this._setupReconnect()),
                                null !== this.pingTimer && (h("_cleanUp :: clearing pingTimer"),
                                    this.pingTimer.clear(),
                                    this.pingTimer = null),
                                t && !this.connected && (h("_cleanUp :: (%s) :: removing stream `done` callback `close` listener", this.options.clientId),
                                    this.stream.removeListener("close", t),
                                    t())
                        }
                        ,
                        v.prototype._sendPacket = function (e, t, r) {
                            if (h("_sendPacket :: (%s) ::  start", this.options.clientId),
                                r = r || w,
                                !this.connected)
                                return h("_sendPacket :: client not connected. Storing packet offline."),
                        ...
                        v.prototype._checkPing = function () {
                            h("_checkPing :: checking ping..."),
                                this.pingResp ? (h("_checkPing :: ping response received. Clearing flag and sending `pingreq`"),
                                    this.pingResp = !1,
                                    this._sendPacket({
                                        cmd: "pingreq"
                        ...
                        v.prototype._handleConnack = function (e) {
                            ...
                            if (clearTimeout(this.connackTimer),
                                e.properties && (e.properties.topicAliasMaximum && (t.properties || (t.properties = {}),
                                    t.properties.topicAliasMaximum = e.properties.topicAliasMaximum),
                                    e.properties.serverKeepAlive && t.keepalive && (t.keepalive = e.properties.serverKeepAlive,
                                        this._shiftPingInterval()),
                                    e.properties.maximumPacketSize && (t.properties || (t.properties = {}),
                        ...
                        v.prototype._handlePublish = function (e, t) {
                            ...
                            switch (h("_handlePublish: qos %d", i),
                            i) {
                                case 2:
                                    a.customHandleAcks(r, n, e, function (r, n) {
                                        return r instanceof Error || (n = r,
                                            r = null),
                                            r ? s.emit("error", r) : -1 === c.indexOf(n) ? s.emit("error", new Error("Wrong reason code for pubrec")) : void (n ? s._sendPacket({
                                                cmd: "pubrec",
                                                messageId: o,
                                                reasonCode: n
                                ...
                                case 1:
                                    a.customHandleAcks(r, n, e, function (i, a) {
                                        return i instanceof Error || (a = i,
                                            i = null),
                                            i ? s.emit("error", i) : -1 === c.indexOf(a) ? s.emit("error", new Error("Wrong reason code for puback")) : (a || s.emit("message", r, n, e),
                        ...
                        v.prototype._handleAck = function (e) {
                            var t, r = e.messageId, n = e.cmd, i = null, o = this.outgoing[r] ? this.outgoing[r].cb : null, s = this;
                            if (o) {
                                switch (h("_handleAck :: packet type", n),
                                n) {
                                    case "pubcomp":
                                    case "puback":
                                        var a = e.reasonCode;
                                        a && a > 0 && 16 !== a && ((t = new Error("Publish error: " + m[a])).code = a,
                                            o(t, e)),
                                    ...
                                    case "pubrec":
                                        ...
                                        var c = e.reasonCode;
                                        c && c > 0 && 16 !== c ? ((t = new Error("Publish error: " + m[c])).code = c,
                                            o(t, e)) : this._sendPacket(i);
                                        break;
                                    case "suback":
                                        delete this.outgoing[r];
                        ...
                        v.prototype._handlePubrel = function (e, t) {
                            ...
                            r.incomingStore.get(e, function (e, i) {
                                e ? r._sendPacket(n, t) : (r.emit("message", i.topic, i.payload, i),
                                    r.handleMessage(i, function (e) {
                                        if (e)
                                            return t(e);
                                        r.incomingStore.del(i, w),
                                            r._sendPacket(n, t)
                                    }))
                            })
                        }
                                        ...
                                        t.once("close", o),
                                            ...
                                            function e() {
                                                if (n) {
                                                    ...
                                                    var r, i = n.read(1);
                                                    i ? t._packetIdsDuringStoreProcessing[i.messageId] ? e() : t.disconnecting || t.reconnectTimer ? n.destroy && n.destroy() : (r = t.outgoing[i.messageId] ? t.outgoing[i.messageId].cb : null,
                                                        ...
                                                        t._packetIdsDuringStoreProcessing[i.messageId] = !0,
                                                        t._sendPacket(i)) : n.once("readable", e)
                                                }
                                            }()
                                    }()
                            }
        ...
        2: [function (e, t, r) {
            (function (r) {
                (function () {
                    "use strict";
                    var n, i, o, s = e("readable-stream").Transform, a = e("duplexify"), c = !1;
                    t.exports = function (e, t) {
                        ...
                        var l = function (e, t) {
                            ...
                            return e.port && 80 !== e.port && 443 !== e.port && (n = r + "://" + e.hostname + ":" + e.port + e.path),
                                "function" == typeof e.transformWsUrl && (n = e.transformWsUrl(n, e, t)),
                                n
                        }(t, e);
                                ...
                                n.onSocketMessage(function (e) {
                                    if ("string" == typeof e.data) {
                                        ...
                                        n.addEventListener("load", function () {
                                            var e = n.result;
                                            e = e instanceof ArrayBuffer ? r.from(e) : r.from(e, "utf8"),
                                                i.push(e)
                                        }),
        ...
        4: [function (e, t, r) {
            ...
            t.exports = function (e, t) {
                ...
                return t.port = t.port || 8883,
                    t.host = t.hostname || t.host || "localhost",
                    t.servername = t.host,
                    t.rejectUnauthorized = !1 !== t.rejectUnauthorized,
                    delete t.path,
                    i("port %d host %s rejectUnauthorized %b", t.port, t.host, t.rejectUnauthorized),
        ...
        5: [function (e, t, r) {
            (function (r, n) {
                (function () {
                    ...
                    const u = void 0 !== r && "browser" === r.title || "function" == typeof __webpack_require__;
                    function l(e, t) {
                    ...
                    function f(e) {
                        let t = e;
                        return e.hostname || (t.hostname = "localhost"),
                            e.port || ("wss" === e.protocol ? t.port = 443 : t.port = 80),
                            e.path || (t.path = "/"),
                            e.wsOptions || (t.wsOptions = {}),
                            u || "wss" !== e.protocol || c.forEach(function (r) {
                    ...
                    t.exports = u ? function (e, t) {
                        ...
                        const i = function (e) {
                            ...
                            return void 0 === t.objectMode && (t.objectMode = !(!0 === t.binary || void 0 === t.binary)),
                                t
                        }(t).browserBufferSize || 524288
                            , c = t.browserBufferTimeout || 1e3
                            , u = !t.objectMode;
                        let h = function (e, t) {
                            ...
                            , p = function (e, t, r) {
                                ...
                                h.bufferedAmount > i && setTimeout(e, c, t, r, o),
                                    u && "string" == typeof t && (t = n.from(t, "utf8"));
                                try {
                                    h.send(t)
                                } catch (e) {
                                    return o(e)
                        ...
                        function _(e, t) {
                            ...
                            for (let t = 0; t < e.length; t++)
                                "string" == typeof e[t].chunk ? r[t] = n.from(e[t], "utf8") : r[t] = e[t].chunk;
                            this._write(n.concat(r), "binary", t)
                        }
                        return h.readyState === h.OPEN ? r = p : (r = r = s(void 0, void 0, t),
                            t.objectMode || (r._writev = _),
                            d ? h.addEventListener("open", g) : h.onopen = g),
                            r.socket = h,
                            d ? (h.addEventListener("close", b),
                                h.addEventListener("error", m),
                                h.addEventListener("message", y)) : (h.onclose = b,
                                    h.onerror = m,
                                    h.onmessage = y),
                            r
                    }
                        : function (e, t) {
                            ...
                            let s = function (e, t, r) {
                                o("createWebSocket"),
                                    o("protocol: " + r.protocolId + " " + r.protocolVersion);
                                const n = "MQIsdp" === r.protocolId && 3 === r.protocolVersion ? "mqttv3.1" : "mqtt";
                                return o("creating new Websocket for url: " + t + " and protocol: " + n),
                    ...
                    t.exports = function (e, t) {
                        ...
                        return o.destroy = function () {
                            ...
                            n.onMessage(function (e) {
                                var t = e.data;
                                t = t instanceof ArrayBuffer ? r.from(t) : r.from(t, "utf8"),
                                    i.push(t)
                            }),
                            n.onClose(function () {
                                o.end(),
        ...
        7: [function (e, t, r) {
            ...
            a.prototype.put = function (e, t) {
                return this._inflights.set(e.messageId, e),
                    t && t(),
                    this
            }
                ,
                ...
                a.prototype.del = function (e, t) {
                    return (e = this._inflights.get(e.messageId)) ? (this._inflights.delete(e.messageId),
                        t(null, e)) : t && t(new Error("missing packet")),
                        this
                }
                ,
            ...
            (function (r) {
                (function () {
                    ...
                    var n = e("../client")
                        ...
                        , c = {};
                    function u(e, t) {
                        if (a("connecting to an MQTT broker..."),
                        ...
                        var u = new n(function (e) {
                            return t.servers && (e._reconnectCount && e._reconnectCount !== t.servers.length || (e._reconnectCount = 0),
                                ...
                                t.hostname = t.host,
                                e._reconnectCount++),
                                a("calling streambuilder for", t.protocol),
                                c[t.protocol](e, t)
                        }
                            , t);
                    ...
                    void 0 !== r && "browser" !== r.title || "function" != typeof __webpack_require__ ? (c.mqtt = e("./tcp"),
                        c.tcp = e("./tcp"),
                        c.ssl = e("./tls"),
                        c.tls = e("./tls"),
                        c.mqtts = e("./tls")) : (c.wx = e("./wx"),
                            c.wxs = e("./wx"),
                            c.ali = e("./ali"),
                            c.alis = e("./ali")),
                        c.ws = e("./ws"),
            ...
            o._init = function (e) {
                ...
                o.prototype.copy = function (e, t, r, i) {
                    ...
                    if (c <= this._bufs[s[0]].length - l)
                        return o ? this._bufs[s[0]].copy(e, t, l, l + c) : this._bufs[s[0]].slice(l, l + c);
                    o || (e = n.allocUnsafe(a));
                    for (let t = s[0]; t < this._bufs.length; t++) {
                        const r = this._bufs[t].length - l;
                        if (!(c > r)) {
                            this._bufs[t].copy(e, u, l, l + c),
                                u += r;
                            break
                        }
                        this._bufs[t].copy(e, u, l),
                            u += r,
                            c -= r,
                            l && (l = 0)
                    }
                ...
                o.prototype.indexOf = function (e, t, r) {
                    ...
                    if ("number" == typeof e ? e = n.from([e]) : "string" == typeof e ? e = n.from(e, r) : this._isBufferList(e) ? e = e.slice() : Array.isArray(e.buffer) ? e = n.from(e.buffer, e.byteOffset, e.byteLength) : n.isBuffer(e) || (e = n.from(e)),
                        t = Number(t || 0),
                        isNaN(t) && (t = 0),
                        t < 0 && (t = this.length + t),
                        t < 0 && (t = 0),
            ...
            (function (t) {
                (function () {
                    ...
                    function E(e, t, r) {
                        ...
                        for (var n = [], i = t; i < r;) {
                            var o, s, a, c, u = e[i], l = null, f = u > 239 ? 4 : u > 223 ? 3 : u > 191 ? 2 : 1;
                            if (i + f <= r)
                                switch (f) {
                                    case 1:
                                        u < 128 && (l = u);
                    ...
                    r.kMaxLength = i,
                        ...
                        s.prototype.compare = function (e, t, r, n, i) {
                            ...
                            if (t >>>= 0,
                                ...
                                this === e)
                                return 0;
                            for (var o = i - n, a = r - t, c = Math.min(o, a), u = this.slice(n, i), l = e.slice(t, r), f = 0; f < c; ++f)
                                if (u[f] !== l[f]) {
                                    o = u[f],
                                        a = l[f];
                                    break
                    ...
                    s(h, i.Duplex),
                        ...
                        h.prototype.setReadable = function (e) {
                            if (this._unread && this._unread(),
                                ...
                                this._drained = !0,
                                    this._readable = e,
                                    this._readable2 = e._readableState ? e : (t = e,
                                        new i.Readable({
                                            objectMode: !0,
                                            highWaterMark: 16
                                        }).wrap(t)),
                        ...
                        h.prototype._write = function (e, t, r) {
                            if (!this.destroyed)
                                return this._corked ? u(this, this._write.bind(this, e, t, r)) : e === c ? this._finish(r) : this._writable ? void (!1 === this._writable.write(e) ? this._ondrain = r : this.destroyed || r()) : r()
                        }
                        ,
                            ...
                            this.emit("preend"),
                                u(this, function () {
                                    ...
                                    r = t._forwardEnd && t._writable,
                                        n = function () {
                                            !1 === t._writableState.prefinished && (t._writableState.prefinished = !0),
                                                t.emit("prefinish"),
                                                u(t, e)
                                        }
                                        ,
                    ...
                    var n = e("once")
                        ...
                        , o = function (e, t, s) {
                            ...
                            var a = e._writableState
                                ...
                                , y = function () {
                                    if (!f)
                                        return (!u || c && c.ended && !c.destroyed) && (!l || a && a.ended && !a.destroyed) ? void 0 : s.call(e, new Error("premature close"))
                                }
                                , _ = function () {
                                    e.req.on("finish", p)
                                };
                        ...
                        case 4:
                            !function (e, t, r, n, i, o) {
                                if (t)
                                    ...
                                    for (var s = e.length, a = b(e, s), c = 0; c < s; ++c)
                                        a[c].call(r, n, i, o)
        ...
        20: [function (e, t, r) {
            r.read = function (e, t, r, n, i) {
                var o, s, a = 8 * i - n - 1, c = (1 << a) - 1, u = c >> 1, l = -7, f = r ? i - 1 : 0, h = r ? -1 : 1, p = e[t + f];
                for (f += h,
                    o = p & (1 << -l) - 1,
                    p >>= -l,
                ...
                r.write = function (e, t, r, n, i, o) {
                    var s, a, c, u = 8 * o - i - 1, l = (1 << u) - 1, f = l >> 1, h = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = n ? 0 : o - 1, d = n ? 1 : -1, g = t < 0 || 0 === t && 1 / t < 0 ? 1 : 0;
                    for (t = Math.abs(t),
            ...
            (function (e) {
                (function () {
                    ...
                    r.CMD_SHIFT = 4,
                        ...
                        r.SESSIONPRESENT_HEADER = e.from([r.SESSIONPRESENT_MASK]),
                        r.CONNACK_HEADER = e.from([r.codes.connack << r.CMD_SHIFT]),
                        r.USERNAME_MASK = 128,
                        r.PASSWORD_MASK = 64,
                        ...
                        r.CONNECT_HEADER = e.from([r.codes.connect << r.CMD_SHIFT]),
                        r.properties = {
                    ...
                    function n(t) {
                        return [0, 1, 2].map(n => [0, 1].map(i => [0, 1].map(o => {
                            const s = e.alloc(1);
                            return s.writeUInt8(r.codes[t] << r.CMD_SHIFT | (i ? r.DUP_MASK : 0) | n << r.QOS_SHIFT | o, 0, !0),
                                s
                        }
                        )))
                    }
                    r.propertiesTypes = {
                        ...
                        r.SUBACK_HEADER = e.from([r.codes.suback << r.CMD_SHIFT]),
                        r.VERSION3 = e.from([3]),
                        r.VERSION4 = e.from([4]),
                        r.VERSION5 = e.from([5]),
                    ...
                    class o extends i {
                        ...
                        concat() {
                            ...
                            for (i = 0; i < n.length && void 0 !== n[i]; i++)
                                "string" != typeof n[i] ? t[i] = n[i].length : t[i] = r.byteLength(n[i]),
                                    e += t[i];
                            const s = r.allocUnsafe(e);
                            for (i = 0; i < n.length && void 0 !== n[i]; i++)
                                "string" != typeof n[i] ? (n[i].copy(s, o),
                                    o += t[i]) : (s.write(n[i], o),
                                        o += t[i]);
                            return s
                        }
        ...
        27: [function (e, t, r) {
            ...
            class c extends i {
                ...
                static parser(e) {
                    return this instanceof c ? (this.settings = e || {},
                        this._states = ["_parseHeader", "_parseLength", "_parsePayload", "_newPacket"],
                        this._resetState(),
                        this) : (new c).parser(e)
                }
                _resetState() {
                    a("_resetState: resetting packet, error, _list, and _stateCounter"),
                        this.packet = new o,
                        this.error = null,
                        this._list = n(),
                ...
                parse(e) {
                    for (this.error && this._resetState(),
                        this._list.append(e),
                        a("parse: current state: %s", this._states[this._stateCounter]); (-1 !== this.packet.length || this._list.length > 0) && this[this._states[this._stateCounter]]() && !this.error;)
                        this._stateCounter++,
                            a("parse: state complete. _stateCounter is now: %d", this._stateCounter),
                            a("parse: packet.length: %d, buffer list length: %d", this.packet.length, this._list.length),
                            this._stateCounter >= this._states.length && (this._stateCounter = 0);
                    return a("parse: exited while loop. packet: %d, buffer list length: %d", this.packet.length, this._list.length),
                        this._list.length
                }
                _parseHeader() {
                    const e = this._list.readUInt8(0);
                    return this.packet.cmd = s.types[e >> s.CMD_SHIFT],
                ...
                _parseLength() {
                    ...
                    return e && (this.packet.length = e.value,
                ...
                _parsePayload() {
                    ...
                    return a("_parsePayload complete result: %s", e),
                        e
                }
                _parseConnect() {
                    let e, t, r, n;
                    ...
                    if (o.protocolVersion = this._list.readUInt8(this._pos),
                        o.protocolVersion >= 128 && (o.bridgeMode = !0,
                            o.protocolVersion = o.protocolVersion - 128),
                        3 !== o.protocolVersion && 4 !== o.protocolVersion && 5 !== o.protocolVersion)
                        return this._emitError(new Error("Invalid protocol version"));
                    if (this._pos++,
                        this._pos >= this._list.length)
                        return this._emitError(new Error("Packet too short"));
                    if (i.username = this._list.readUInt8(this._pos) & s.USERNAME_MASK,
                        i.password = this._list.readUInt8(this._pos) & s.PASSWORD_MASK,
                        i.will = this._list.readUInt8(this._pos) & s.WILL_FLAG_MASK,
                        i.will && (o.will = {},
                            o.will.retain = 0 != (this._list.readUInt8(this._pos) & s.WILL_RETAIN_MASK),
                            o.will.qos = (this._list.readUInt8(this._pos) & s.WILL_QOS_MASK) >> s.WILL_QOS_SHIFT),
                        o.clean = 0 != (this._list.readUInt8(this._pos) & s.CLEAN_SESSION_MASK),
                        this._pos++,
                    ...
                    if (o.clientId = u,
                        ...
                        if (o.will.topic = e,
                            a("_parseConnect: packet.will.topic: %s", o.will.topic),
                            null === (t = this._parseBuffer()))
                            return this._emitError(new Error("Cannot parse will payload"));
                        o.will.payload = t,
                            a("_parseConnect: packet.will.paylaod: %s", o.will.payload)
                    }
                    if (i.username) {
                ...
                _parseSubscribe() {
                    ...
                    if (e.subscriptions = [],
                        ...
                        for (; this._pos < e.length;) {
                            ...
                            n = (r = this._parseByte()) & s.SUBSCRIBE_OPTIONS_QOS_MASK,
                                c = 0 != (r >> s.SUBSCRIBE_OPTIONS_NL_SHIFT & s.SUBSCRIBE_OPTIONS_NL_MASK),
                                o = 0 != (r >> s.SUBSCRIBE_OPTIONS_RAP_SHIFT & s.SUBSCRIBE_OPTIONS_RAP_MASK),
                                i = r >> s.SUBSCRIBE_OPTIONS_RH_SHIFT & s.SUBSCRIBE_OPTIONS_RH_MASK,
                                u = {
                                    topic: t,
                                    qos: n
                                },
                                5 === this.settings.protocolVersion ? (u.nl = c,
                                    u.rap = o,
                                    u.rh = i) : this.settings.bridgeMode && (u.rh = 0,
                                        u.rap = !0,
                                        u.nl = !0),
                                a("_parseSubscribe: push subscription `%s` to subscription", u),
                ...
                _parseUnsubscribe() {
                    ...
                    if (e.unsubscriptions = [],
                        ...
                        for (; this._pos < e.length;) {
                            ...
                            if (null === t)
                                return this._emitError(new Error("Cannot parse topic"));
                            a("_parseUnsubscribe: push topic `%s` to unsubscriptions", t),
                ...
                _parseUnsuback() {
                    ...
                    if (5 === this.settings.protocolVersion) {
                        const t = this._parseProperties();
                        for (Object.getOwnPropertyNames(t).length && (e.properties = t),
                            e.granted = []; this._pos < this.packet.length;)
                            this.packet.granted.push(this._list.readUInt8(this._pos++))
                    }
                }
                _parseConfirmation() {
                    ...
                    const e = this.packet;
                    if (this._parseMessageId(),
                        5 === this.settings.protocolVersion && (e.length > 2 ? (e.reasonCode = this._parseByte(),
                            a("_parseConfirmation: packet.reasonCode `%d`", e.reasonCode)) : e.reasonCode = 0,
                            e.length > 3)) {
                        const t = this._parseProperties();
                        Object.getOwnPropertyNames(t).length && (e.properties = t)
                    }
                ...
                _parseAuth() {
                    ...
                    const t = this._parseProperties();
                    return Object.getOwnPropertyNames(t).length && (e.properties = t),
                ...
                _parseMessageId() {
                    ...
                    return e.messageId = this._parseNum(),
                        null === e.messageId ? (this._emitError(new Error("Cannot parse messageId")),
                            !1) : (a("_parseMessageId: packet.messageId %d", e.messageId),
                                !0)
                }
                _parseString(e) {
                ...
                _parseVarByteNum(e) {
                    a("_parseVarByteNum");
                    let t, r = 0, n = 1, i = 0, o = !1;
                    const c = this._pos ? this._pos : 0;
                    for (; r < 4 && c + r < this._list.length;) {
                        if (i += n * ((t = this._list.readUInt8(c + r++)) & s.VARBYTEINT_MASK),
                            n *= 128,
                    ...
                    return !o && 4 === r && this._list.length >= r && this._emitError(new Error("Invalid variable byte integer")),
                        c && (this._pos += r),
                        a("_parseVarByteNum: result: %o", o = !!o && (e ? {
                            bytes: r,
                            value: i
                        } : i)),
                        o
                ...
                _parseByte() {
                    let e;
                    return this._pos < this._list.length && (e = this._list.readUInt8(this._pos),
                        this._pos++),
                        a("_parseByte: result: %o", e),
                        e
                }
                _parseByType(e) {
                    switch (a("_parseByType: type: %s", e),
                    e) {
                        case "byte":
                    ...
                    for (; this._pos < t;) {
                        ...
                        if (!t)
                            return this._emitError(new Error("Unknown property")),
                                !1;
                        if ("userProperties" !== t)
                            r[t] ? Array.isArray(r[t]) ? r[t].push(this._parseByType(s.propertiesTypes[t])) : (r[t] = [r[t]],
                                r[t].push(this._parseByType(s.propertiesTypes[t]))) : r[t] = this._parseByType(s.propertiesTypes[t]);
                        else {
                ...
                _newPacket() {
                    return a("_newPacket"),
                        this.packet && (this._list.consume(this.packet.length),
                            a("_newPacket: parser emit packet: packet.cmd: %s, packet.payload: %s, packet.length: %d", this.packet.cmd, this.packet.payload, this.packet.length),
            ...
            (function (r) {
                (function () {
                    const n = e("./constants")
                        ...
                        , c = e("debug")("mqtt-packet:writeToStream")
                        , u = s.cache
                        , l = s.generateNumber
                        , f = s.generateCache
                    ...
                    let d = S
                        , g = !0;
                    function b(e, t, s) {
                        switch (c("generate called"),
                        t.cork && (t.cork(),
                            a(m, t)),
                        g && (g = !1,
                            f()),
                        c("generate: packet.cmd: %s", e.cmd),
                        e.cmd) {
                            case "connect":
                                return function (e, t, i) {
                                    ...
                                    if (!s || "string" != typeof s && !r.isBuffer(s))
                                        return t.emit("error", new Error("Invalid protocolId")),
                                            !1;
                                    b += s.length + 2;
                                    if (3 !== a && 4 !== a && 5 !== a)
                                        return t.emit("error", new Error("Invalid protocol version")),
                                            !1;
                                    b += 1;
                                    if (("string" == typeof f || r.isBuffer(f)) && (f || a >= 4) && (f || u))
                                        b += r.byteLength(f) + 2;
                                    else {
                                        if (a < 4)
                                            return t.emit("error", new Error("clientId must be supplied before 3.1.1")),
                                                !1;
                                        if (1 * u == 0)
                                            return t.emit("error", new Error("clientId must be given if cleanSession set to 0")),
                                                !1
                                    }
                                    if ("number" != typeof l || l < 0 || l > 65535 || l % 1 != 0)
                                        return t.emit("error", new Error("Invalid keepalive")),
                                            !1;
                                    b += 2;
                                    if (b += 1,
                                        5 === a) {
                                    ...
                                    if (c) {
                                        if ("object" != typeof c)
                                            return t.emit("error", new Error("Invalid will")),
                                                !1;
                                        if (!c.topic || "string" != typeof c.topic)
                                            return t.emit("error", new Error("Invalid will topic")),
                                                !1;
                                        if (b += r.byteLength(c.topic) + 2,
                                            b += 2,
                                            c.payload) {
                                            if (!(c.payload.length >= 0))
                                                return t.emit("error", new Error("Invalid will payload")),
                                                    !1;
                                            "string" == typeof c.payload ? b += r.byteLength(c.payload) : b += c.payload.length
                                        }
                                        var y = {};
                                        if (5 === a) {
                                            if (!(y = I(t, c.properties)))
                                                return !1;
                                            b += y.length
                                        }
                                    }
                                    ...
                                    if (null != h) {
                                        if (!O(h))
                                            return t.emit("error", new Error("Invalid username")),
                                                !1;
                                        v = !0,
                                            b += r.byteLength(h) + 2
                                    }
                                    if (null != p) {
                                        if (!v)
                                            return t.emit("error", new Error("Username is required to use password")),
                                                !1;
                                        if (!O(p))
                                            return t.emit("error", new Error("Invalid password")),
                                                !1;
                                        b += R(p) + 2
                                    }
                            ...
                            case "connack":
                                return function (e, t, i) {
                                    ...
                                    let l = 2;
                                    if ("number" != typeof c)
                                        return t.emit("error", new Error("Invalid return code")),
                                            !1;
                                    let f = null;
                                    if (5 === s) {
                                        if (!(f = I(t, u)))
                            ...
                            case "publish":
                                return function (e, t, o) {
                                    ...
                                    if ("string" == typeof f)
                                        ...
                                        if (!r.isBuffer(f))
                                            return t.emit("error", new Error("Invalid topic")),
                                                !1;
                                        b += f.length + 2
                                    }
                                    r.isBuffer(h) ? b += h.length : b += r.byteLength(h);
                                    if (u && "number" != typeof p)
                                        return t.emit("error", new Error("Invalid messageId")),
                                            !1;
                                    u && (b += 2);
                                    let m = null;
                                    if (5 === s) {
                                    ...
                                    t.write(n.PUBLISH_HEADER[u][a.dup ? 1 : 0][l ? 1 : 0]),
                                        _(t, b),
                                        d(t, R(f)),
                                        t.write(f),
                                        u > 0 && d(t, p);
                                    null != m && m.write();
                                    return c("publish: payload: %o", h),
                                        t.write(h)
                                }(e, t, s);
                            case "puback":
                            case "pubrec":
                            ...
                            case "subscribe":
                                return function (e, t, i) {
                                    ...
                                    if ("object" != typeof l || !l.length)
                                        return t.emit("error", new Error("Invalid subscriptions")),
                                            !1;
                                    for (let e = 0; e < l.length; e += 1) {
                                        const n = l[e].topic
                                            , i = l[e].qos;
                                        if ("string" != typeof n)
                                            return t.emit("error", new Error("Invalid subscriptions - invalid topic")),
                                                !1;
                                        if ("number" != typeof i)
                                            return t.emit("error", new Error("Invalid subscriptions - invalid qos")),
                                                !1;
                                        if (5 === o) {
                                            const r = l[e].nl || !1;
                                            if ("boolean" != typeof r)
                                                return t.emit("error", new Error("Invalid subscriptions - invalid No Local")),
                                                    !1;
                                            const n = l[e].rap || !1;
                                            if ("boolean" != typeof n)
                                                return t.emit("error", new Error("Invalid subscriptions - invalid Retain as Published")),
                                                    !1;
                                            const i = l[e].rh || 0;
                                            if ("number" != typeof i || i > 2)
                                                return t.emit("error", new Error("Invalid subscriptions - invalid Retain Handling")),
                                                    !1
                                        }
                                        h += r.byteLength(n) + 2 + 1
                                    }
                                    c("subscribe: writing to stream: %o", n.SUBSCRIBE_HEADER),
                                    ...
                                    for (const e of l) {
                                        ...
                                        let l;
                                        w(t, i),
                                            l = n.SUBSCRIBE_OPTIONS_QOS[s],
                                            5 === o && (l |= a ? n.SUBSCRIBE_OPTIONS_NL : 0,
                                                l |= c ? n.SUBSCRIBE_OPTIONS_RAP : 0,
                                                l |= u ? n.SUBSCRIBE_OPTIONS_RH[u] : 0),
                                            g = t.write(r.from([l]))
                                    }
                                    return g
                                }(e, t, s);
                            case "suback":
                                return function (e, t, i) {
                                    ...
                                    if ("object" != typeof c || !c.length)
                                        return t.emit("error", new Error("Invalid qos vector")),
                                            !1;
                            ...
                            case "unsubscribe":
                                return function (e, t, i) {
                                    ...
                                    if ("object" != typeof u || !u.length)
                                        return t.emit("error", new Error("Invalid unsubscriptions")),
                                            !1;
                                    for (let e = 0; e < u.length; e += 1) {
                                        if ("string" != typeof u[e])
                                            return t.emit("error", new Error("Invalid unsubscriptions")),
                                                !1;
                                        f += r.byteLength(u[e]) + 2
                                    }
                                    let h = null;
                                    if (5 === o) {
                                        if (!(h = I(t, l)))
                            ...
                            default:
                                return t.emit("error", new Error("Unknown command")),
                                    !1
                        }
                    }
                    function m(e) {
                    ...
                    Object.defineProperty(b, "cacheNumbers", {
                        get: () => d === S,
                        set(e) {
                            e ? (u && 0 !== Object.keys(u).length || (g = !0),
                                d = S) : (g = !1,
                                    d = E)
                        }
                    });
                    ...
                    function _(e, t) {
                        if (t > n.VARBYTEINT_MAX)
                            return e.emit("error", new Error(`Invalid variable byte integer: ${t}`)),
                                !1;
                        let r = y[t];
                        return r || (r = h(t),
                            t < 16384 && (y[t] = r)),
                            c("writeVarByteInt: writing to stream: %o", r),
                            e.write(r)
                    }
                    function w(e, t) {
                    ...
                    function S(e, t) {
                        return c("writeNumberCached: number: %d", t),
                            c("writeNumberCached: %o", u[t]),
                            e.write(u[t])
                    }
                    function E(e, t) {
                        const r = l(t);
                        return c("writeNumberGenerated: %o", r),
                            e.write(r)
                    }
                    function k(e, t) {
                        "string" == typeof t ? w(e, t) : t ? (d(e, t.length),
                            e.write(t)) : d(e, 0)
                    }
                    function I(e, t) {
                        ...
                        function o(t, i) {
                            ...
                            switch (n.propertiesTypes[t]) {
                                case "byte":
                                    if ("boolean" != typeof i)
                                        return e.emit("error", new Error(`Invalid ${t}: ${i}`)),
                                            !1;
                                    o += 2;
                                    break;
                                case "int8":
                                ...
                                case "pair":
                                    ...
                                    o += Object.getOwnPropertyNames(i).reduce((e, t) => {
                                        const n = i[t];
                                        return Array.isArray(n) ? e += n.reduce((e, n) => e += 3 + r.byteLength(t.toString()) + 2 + r.byteLength(n.toString()), 0) : e += 3 + r.byteLength(t.toString()) + 2 + r.byteLength(i[t].toString()),
                                            e
                                    }
                                        , 0);
                                    break;
                                default:
                                    return e.emit("error", new Error(`Invalid property ${t}: ${i}`)),
                                        !1
                            }
                            return o
                        }
                            ...
                            case "pair":
                                Object.getOwnPropertyNames(i).forEach(o => {
                                    ...
                                    Array.isArray(s) ? s.forEach(i => {
                                        e.write(r.from([n.properties[t]])),
                                            v(e, o.toString(), i.toString())
                                    }
                                    ) : (e.write(r.from([n.properties[t]])),
                                        v(e, o.toString(), s.toString()))
                                }
                                );
                                break;
                            default:
                                return e.emit("error", new Error(`Invalid property ${t} value: ${i}`)),
                                    !1
                        }
                    }
                    function A(e, t, r) {
            ...
            (function (e) {
                (function () {
                    !function (n) {
                        ...
                        var a, c, u = 2147483647, l = 36, f = 1, h = 26, p = 38, d = 700, g = 72, b = 128, m = "-", y = /^xn--/, _ = /[^\x20-\x7E]/, w = /[\x2E\u3002\uFF0E\uFF61]/g, v = {
                            overflow: "Overflow: input needs wider integers to process",
                            "not-basic": "Illegal input >= 0x80 (not a basic code point)",
                            "invalid-input": "Invalid input"
                        }, S = l - f, E = Math.floor, k = String.fromCharCode;
                        function I(e) {
                        ...
                        function T(e, t) {
                            ...
                            return r.length > 1 && (n = r[0] + "@",
                                e = r[1]),
                                n + C((e = e.replace(w, ".")).split("."), t).join(".")
                        }
                        function A(e) {
                            for (var t, r, n = [], i = 0, o = e.length; i < o;)
                                (t = e.charCodeAt(i++)) >= 55296 && t <= 56319 && i < o ? 56320 == (64512 & (r = e.charCodeAt(i++))) ? n.push(((1023 & t) << 10) + (1023 & r) + 65536) : (n.push(t),
                                    i--) : n.push(t);
                            return n
                        }
                        function R(e) {
                        ...
                        function P(e) {
                            var t, r, n, i, o, s, a, c, p, d, y, _ = [], w = e.length, v = 0, S = b, k = g;
                            ...
                            for (i = r > 0 ? r + 1 : 0; i < w;) {
                                for (o = v,
                                    s = 1,
                                    a = l; i >= w && I("invalid-input"),
                                    ((c = (y = e.charCodeAt(i++)) - 48 < 10 ? y - 22 : y - 65 < 26 ? y - 65 : y - 97 < 26 ? y - 97 : l) >= l || c > E((u - v) / s)) && I("overflow"),
                                    v += c * s,
                                    !(c < (p = a <= k ? f : a >= k + h ? h : a - k)); a += l)
                                    s > E(u / (d = l - p)) && I("overflow"),
                                        s *= d;
                                k = x(v - o, t = _.length + 1, 0 == o),
                                    E(v / t) > u - S && I("overflow"),
                                    S += E(v / t),
                                    v %= t,
                                    _.splice(v++, 0, S)
                            }
                        ...
                        function M(e) {
                            var t, r, n, i, o, s, a, c, p, d, y, _, w, v, S, C = [];
                            for (_ = (e = A(e)).length,
                                t = b,
                                r = 0,
                                o = g,
                            ...
                            for (n = i = C.length,
                                ...
                                for (a = u,
                                    s = 0; s < _; ++s)
                                    (y = e[s]) >= t && y < a && (a = y);
                                for (a - t > E((u - r) / (w = n + 1)) && I("overflow"),
                                    r += (a - t) * w,
                                    t = a,
                                    s = 0; s < _; ++s)
                                    if ((y = e[s]) < t && ++r > u && I("overflow"),
                                        y == t) {
                                        for (c = r,
                                            p = l; !(c < (d = p <= o ? f : p >= o + h ? h : p - o)); p += l)
                                            S = c - d,
                                                v = l - d,
                                                C.push(k(O(d + S % v, 0))),
                                                c = E(S / v);
                    ...
                    function C(e, t, r, n, i) {
                        ...
                        if (null === t)
                            ...
                            if ("string" == typeof t || s.objectMode || Object.getPrototypeOf(t) === a.prototype || (t = function (e) {
                                ...
                                n)
                                s.endEmitted ? S(e, new v) : T(e, s, t, !0);
                            else if (s.ended)
                                S(e, new _);
                            else {
                                if (s.destroyed)
                                ...
                                s.reading = !1,
                                    s.decoder && !r ? (t = s.decoder.write(t),
                                        s.objectMode || 0 !== t.length ? T(e, s, t, !1) : P(e, s)) : T(e, s, t, !1)
                            }
                        else
                            n || (s.reading = !1,
                                P(e, s));
                    ...
                    I.prototype.read = function (e) {
                        ...
                        return u("need readable", i),
                            ...
                            t.ended || t.reading ? u("reading or ended", i = !1) : i && (u("do read"),
                                ...
                                t.sync = !1,
                                t.reading || (e = R(r, t))),
                            null === (n = e > 0 ? j(e, t) : null) ? (t.needReadable = t.length <= t.highWaterMark,
                                e = 0) : (t.length -= e,
                                    t.awaitDrain = 0),
                        ...
                        I.prototype.pipe = function (e, t) {
                            ...
                            function h(t) {
                                ...
                                var r = e.write(t);
                                u("dest.write", r),
                                    !1 === r && ((1 === i.pipesCount && i.pipes === e || i.pipesCount > 1 && -1 !== F(i.pipes, e)) && !f && (u("false write response, pause", i.awaitDrain),
                                        i.awaitDrain++),
                                        n.pause())
                            }
                            function p(t) {
                        ...
                        I.prototype.on = function (e, t) {
                            ...
                            return "data" === e ? (i.readableListening = this.listenerCount("readable") > 0,
                                !1 !== i.flowing && this.resume()) : "readable" === e && (i.endEmitted || i.readableListening || (i.readableListening = i.needReadable = !0,
                                    ...
                                    i.length ? O(this) : i.reading || r.nextTick(B, this))),
                                n
                        }
                        ,
                        ...
                        I.prototype.removeListener = function (e, t) {
                            ...
                            return "readable" === e && r.nextTick(L, this),
                                n
                        }
                        ,
                        I.prototype.removeAllListeners = function (e) {
                            var t = s.prototype.removeAllListeners.apply(this, arguments);
                            return "readable" !== e && void 0 !== e || r.nextTick(L, this),
                                t
                        }
                        ,
                        ...
                        "function" == typeof Symbol && (I.prototype[Symbol.asyncIterator] = function () {
                            return void 0 === h && (h = e("./internal/streams/async_iterator")),
                                h(this)
                        }
                        ),
                ...
                (function () {
                            ...
                            this.onwrite = function (e) {
                                !function (e, t) {
                                    ...
                                    if (function (e) {
                                        ...
                                        s || n.corked || n.bufferProcessing || !n.bufferedRequest || A(e, n),
                        ...
                        if (e._writev && r && r.next) {
                            ...
                            for (; r;) {
                                var u = r.chunk
                                    , l = r.encoding
                                    , f = r.callback;
                                if (C(e, t, !1, t.objectMode ? 1 : u.length, u, l, f),
                                    r = r.next,
                    ...
                    e("inherits")(I, a),
                        ...
                        I.prototype.write = function (e, t, n) {
                            ...
                            return a && !c.isBuffer(e) && (e = function (e) {
                                ...
                                o.ending ? function (e, t) {
                                    ...
                                    var o;
                                    return null === n ? o = new _ : "string" == typeof n || t.objectMode || (o = new d("chunk", ["string", "Buffer"], n)),
                                        !o || (S(e, o),
                                            r.nextTick(i, o),
                                            !1)
                        ...
                        I.prototype.uncork = function () {
                            ...
                            e.corked && (e.corked--,
                                e.writing || e.corked || e.bufferProcessing || !e.bufferedRequest || A(this, e))
                        }
                        ,
        ...
        46: [function (e, t, r) {
            ...
            t.exports = function e(t, r, o) {
                ...
                return function (e) {
                    ...
                    t.on("abort", d),
                    t.req ? g() : t.on("request", g)) : a && !t._writableState && (t.on("end", c),
                        t.on("close", c)),
                    t.on("end", h),
                    t.on("finish", l),
        ...
        54: [function (e, t, r) {
            t.exports = function (e) {
                var t = e._readableState;
                return t ? t.objectMode || "number" == typeof e._duplexState ? e.read() : e.read((r = t,
                    r.buffer.length ? r.buffer.head ? r.buffer.head.data.length : r.buffer[0].length : r.length)) : null;
                var r
            }
        }
            , {}],
        ...
        56: [function (e, t, r) {
            ...
            o.prototype.parse = function (e, t, r) {
                ...
                if (r || v || _.match(/^\/\/[^@\/]+@[^@\/]+/)) {
                    var E = "//" === _.substr(0, 2);
                    !E || v && b[v] || (_ = _.substr(2),
                        this.slashes = !0)
                }
                if (!b[v] && (E || v && !m[v])) {
                    for (var k, I, C = -1, T = 0; T < h.length; T++) {
                        -1 !== (A = _.indexOf(h[T])) && (-1 === C || A < C) && (C = A)
                    }
                    -1 !== (I = -1 === C ? _.lastIndexOf("@") : _.lastIndexOf("@", C)) && (k = _.slice(0, I),
                        _ = _.slice(I + 1),
                        this.auth = decodeURIComponent(k)),
                        C = -1;
                    for (T = 0; T < f.length; T++) {
                        var A;
                        -1 !== (A = _.indexOf(f[T])) && (-1 === C || A < C) && (C = A)
                    }
                    -1 === C && (C = _.length),
                    ...
                    if (!R)
                        for (var O = this.hostname.split(/\./), x = (T = 0,
                            O.length); T < x; T++) {
                            var P = O[T];
                            if (P && !P.match(p)) {
                ...
                var W = _.indexOf("#");
                -1 !== W && (this.hash = _.substr(W),
                    _ = _.slice(0, W));
                var H = _.indexOf("?");
                if (-1 !== H ? (this.search = _.substr(H),
                    this.query = _.substr(H + 1),
                    t && (this.query = y.parse(this.query)),
                    _ = _.slice(0, H)) : t && (this.search = "",
                        this.query = {}),
                    _ && (this.pathname = _),
                ...
                o.prototype.format = function () {
                    ...
                    this.host ? o = e + this.host : this.hostname && (o = e + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"),
                        ...
                        this.query && i.isObject(this.query) && Object.keys(this.query).length && (s = y.stringify(this.query));
                    var a = this.search || s && "?" + s || "";
                    return t && ":" !== t.substr(-1) && (t += ":"),
                        this.slashes || (!t || m[t]) && !1 !== o ? (o = "//" + (o || ""),
                ...
                o.prototype.resolveObject = function (e) {
                    ...
                    if (!E.length)
                        return r.pathname = null,
                            ...
                            r.href = r.format(),
                            r;
                    for (var I = E.slice(-1)[0], C = (r.host || e.host || E.length > 1) && ("." === I || ".." === I) || "" === I, T = 0, A = E.length; A >= 0; A--)
                        "." === (I = E[A]) ? E.splice(A, 1) : ".." === I ? (E.splice(A, 1),
                            T++) : T && (E.splice(A, 1),
                                T--);
                    if (!v && !S)
                        for (; T--; T)
                    ...
                    k && (r.hostname = r.host = O ? "" : E.length ? E.shift() : "",
                        (R = !!(r.host && r.host.indexOf("@") > 0) && r.host.split("@")) && (r.auth = R.shift(),
                            r.host = r.hostname = R.shift()));
                    return (v = v || r.host && E.length) && !O && E.unshift(""),
